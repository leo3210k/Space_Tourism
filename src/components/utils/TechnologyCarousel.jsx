        ...
        <div className={`${styles.embla__container}`}>
          {slides.map((technology) => (
            <div className={`${styles.embla__slide} flex flex-col items-center`} key={technology}>
              ...
              <div className='flex flex-col items-center md:gap-2 mt-20'>
                ...
                <span className='w-5/6 font-barlow text-base md:text-lg text-center text-tropical_blue md:leading-8 mt-3'>{technology.description}</span>
              </div>
            </div>
          ))}
        </div>
