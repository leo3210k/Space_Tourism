...
const EmblaCarousel = (props) => {
  ...
  return (
    <section className={`${styles.embla} relative`}>
        ...
        <div className={`${styles.embla__container}`}>
          {slides.map((person) => (
            <div className={`${styles.embla__slide} flex flex-col items-center lg:items-start`} key={person}>
              <img className='md:absolute h-56 lg:self-end md:h-[33.25rem] lg:h-[44.5rem] md:-bottom-[40.5rem] lg:-bottom-[38vh]' src={person.src} alt={person.name} />
      ...
      <div className={`${styles.embla__controls} absolute inset-x-0 top-64 md:top-[14.6rem] lg:top-[27rem] lg:inset-x-auto`}>
