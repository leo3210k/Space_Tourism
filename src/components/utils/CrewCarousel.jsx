        ...
        <div className={`${styles.embla__container}`}>
          {slides.map((person) => (
            <div className={`${styles.embla__slide} flex flex-col items-center`} key={person}>
              <img className='md:absolute h-56 md:h-[33.25rem] md:order-1 md:-bottom-96' src={person.src} alt={person.name} />
              ...
              <div className='flex flex-col items-center mt-16'>
                ...
                <span className='w-5/6 font-barlow text-base md:text-lg text-center text-tropical_blue mt-3'>{person.description}</span>
              </div>
            </div>
          ))}
        </div>
