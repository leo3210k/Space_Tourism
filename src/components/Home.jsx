...
function Home() {
  return (
    <div className="flex flex-col lg:flex-row items-center mt-16 md:mt-24">
      <div className='flex flex-col items-center'>
        ...
        <span className="w-5/6 md:w-3/6 text-lg text-tropical_blue font-barlow line-clamp-5 text-center leading-7 mt-6">
          Let’s face it; if you want to go to space, you might as well genuinely go to outer space 
          and not hover kind of on the edge of it. Well sit back, and relax because we’ll give you a 
          truly out of this world experience!
        </span>
      </div>
      <div className="relative group cursor-pointer mt-36">
