...
function PickDestination() {
  ...
  return (
    <div className='flex flex-col justify-center items-center gap-6 md:gap-12 mt-5 md:mt-8 lg:mt-12 lg:mx-28'>
      ...
      <Tabs defaultValue="moon" className="w-[400px] md:w-11/12 lg:w-full flex flex-col lg:flex-row lg:justify-between items-center md:gap-2 text-white">
        <div>
